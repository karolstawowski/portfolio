export const Monitor = (): JSX.Element => {
  return (
    <div className="w-[800px] h-[560px] scale-[.3] -mb-96 lg:-mb-64 xl:-mb-52 2xl:-mb-36 origin-top-left mt-8 sm:-mt-32 md:-mt-24 lg:scale-50 lg:-mt-20 2xl:-mt-16 xl:scale-[0.6] 2xl:scale-[0.7]">
